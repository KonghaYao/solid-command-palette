import { RootProps, StoreState, Action, Actions, ReactiveStore } from '../types';
import { Atom, atomization, reflect } from '@cn-ui/use';

/** 兼容四种形态的 actions 参数 */
export const TransformActionsProp = (props: RootProps): Pick<ReactiveStore, 'actions' | 'actionsMap'> => {
